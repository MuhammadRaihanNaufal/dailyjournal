...
<head>
    ...
    <title>Profile Admin | My Mountain Journal</title>
            ...
            <div class="mb-3">
                ...
                <div class="d-flex justify-content-start">
                    <div class="img-thumbnail" style="width: 100px;">
                        <img src="<?= !empty($user_data['foto']) ? 'img/' . htmlspecialchars($user_data['foto']) : 'img/default-profile.png' ?>" alt="Current Profile Photo" class="img-fluid">
                    </div>
                </div>
            </div>
