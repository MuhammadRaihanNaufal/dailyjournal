                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="judul" placeholder="Tuliskan Judul Article" required>
                            </div>
                            <div class="mb-3">
                                <label for="floatingTextarea2">Isi</label>
                                <textarea class="form-control" placeholder="Tuliskan Isi Article" name="isi" required></textarea>
                            </div>
                            <div class="mb-3">
...
if (isset($_POST['hapus'])) {
    ...
    if ($hapus) {
        echo "<script>
            alert('Hapus article sukses!');
            document.location='admin.php?page=article';
        </script>";
    } else {
        echo "<script>
            alert('Hapus article gagal!');
            document.location='admin.php?page=article';
        </script>";
    }
